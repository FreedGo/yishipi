...
<div class="hymain">
  <div class="block">
    ...
    <div class="fr rmain">
      <h3>订单详情</h3>
      <div class="tips" style="position:relative; padding-left:30px;"><i class="icon icon-1"></i>当前订单号: <span class="f12 st cred"><?=$r[ddno]?></span> 下单时间: <span class="f12 st cred"><?=$r[ddtime]?></span></div>
      <div class="tab">
        ...
        <ul>
          <li class="tabhover"><a href="javascript:void();">商品信息</a></li>
