            ...
            <table>
                ...
                ?>
                    <tr>
                        ...
                        <input type="hidden" name="tprice[]" value="<?=$r['tprice']?>">
                        
                        
                        
                        <td><input type="checkbox" name="del[]" value="<?=$r['id']?>" class="delbox"></td>
                        ...
                        <td>￥<span class="price"><?=$r[tprice]?></span><br>(<del>￥<?=$r[tprice]?></del>)</td>
