...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>图片大图</td><td bgcolor='ffffff'><input name="picurl" type="text" id="picurl" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[picurl]))?>" size="45">
