...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>简单描述</td><td bgcolor='ffffff'><textarea name="intro" cols="60" rows="10" id="intro"><?=$ecmsfirstpost==1?"":DoReqValue($mid,'intro',stripSlashes($r[intro]))?></textarea>
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>品牌</td><td bgcolor='ffffff'>
<input name="brand" type="text" id="brand" value="<?=$ecmsfirstpost==1?"":DoReqValue($mid,'brand',stripSlashes($r[brand]))?>" size="">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>到期时间</td><td bgcolor='ffffff'><input name="expday" type="text" id="expday" value="<?=$ecmsfirstpost==1?"":ehtmlspecialchars(stripSlashes($r[expday]))?>" size="12" onclick="setday(this);">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>条形码</td><td bgcolor='ffffff'>
<input name="bar_code" type="text" id="bar_code" value="<?=$ecmsfirstpost==1?"":DoReqValue($mid,'bar_code',stripSlashes($r[bar_code]))?>" size="">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>货号</td><td bgcolor='ffffff'>
<input name="no" type="text" id="no" value="<?=$ecmsfirstpost==1?"":DoReqValue($mid,'no',stripSlashes($r[no]))?>" size="">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>过关单</td><td bgcolor='ffffff'>
<input type="file" name="pass_customs_pathfile" size="45">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>税单</td><td bgcolor='ffffff'>
<input type="file" name="bill_pathfile" size="45">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>卫生检测证明</td><td bgcolor='ffffff'>
...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>建议零售价</td><td bgcolor='ffffff'><input name="dan_price" type="text" id="dan_price" value="<?=$ecmsfirstpost==1?"":DoReqValue($mid,'dan_price',stripSlashes($r[dan_price]))?>" size="">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>单价</td><td bgcolor='ffffff'><input name="tprice" type="text" id="tprice" value="<?=$ecmsfirstpost==1?"":DoReqValue($mid,'tprice',stripSlashes($r[tprice]))?>" size="60">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>箱价</td><td bgcolor='ffffff'><input name="price" type="text" id="price" value="<?=$ecmsfirstpost==1?"":DoReqValue($mid,'price',stripSlashes($r[price]))?>" size="60">
...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>产地</td><td bgcolor='ffffff'>
<input name="chandi" type="text" id="chandi" value="<?=$ecmsfirstpost==1?"":DoReqValue($mid,'chandi',stripSlashes($r[chandi]))?>" size="60">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>起批量</td><td bgcolor='ffffff'>
...
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>库存</td><td bgcolor='ffffff'><input name="pmaxnum" type="text" id="pmaxnum" value="<?=$ecmsfirstpost==1?"100":DoReqValue($mid,'pmaxnum',stripSlashes($r[pmaxnum]))?>" size="">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>配送方式</td><td bgcolor='ffffff'><select name="express" id="express"><option value="运东西网"<?=$r[express]=="运东西网"||$ecmsfirstpost==1?' selected':''?>>运东西网</option><option value="快递鸟"<?=$r[express]=="快递鸟"?' selected':''?>>快递鸟</option><option value="自行取货"<?=$r[express]=="自行取货"?' selected':''?>>自行取货</option></select></td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>体积</td><td bgcolor='ffffff'>
<input name="tiji" type="text" id="tiji" value="<?=$ecmsfirstpost==1?"":DoReqValue($mid,'tiji',stripSlashes($r[tiji]))?>" size="">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>服务</td><td bgcolor='ffffff'>
<input name="fuwu" type="text" id="fuwu" value="<?=$ecmsfirstpost==1?"":DoReqValue($mid,'fuwu',stripSlashes($r[fuwu]))?>" size="">
</td></tr><tr><td width='16%' height=25 bgcolor='ffffff'>产品图</td><td bgcolor='ffffff'><link rel="stylesheet" type="text/css" href="/zjk/oss/webuploader.css" />
...
<input type="hidden" name="productpic" value="" id="photos" />
  <div id="wrapper">
    ...
    <script type="text/javascript" src="/zjk/oss/upload.js"></script></td></tr><tr><td height=25 colspan=2 bgcolor='ffffff'><div align=left>商品介绍</div></td></tr></table><div style='background-color:#D0D0D0'><?php if(!isset($Field)){ ?>
