    ...
    <div class="fr rmain">
      ...
      <div class="tab">
        ...
        <ul>
          ...
          <li class="tabhover"><a href="/e/member/EditInfo/EditSafeInfo.php">密码修改</a></li>
        ...
        <div id="edituserxx">
          <table width="100%" align="center" cellpadding="3" cellspacing="0" bgcolor="">
            <tbody>
              ...
              <tr>
                <td width="" height="25" bgcolor="" style="width: 70px;">原密码</td>
                <td bgcolor="" width=""><input name='oldpassword' type='password' id='oldpassword' size="38" maxlength='20'>
        (修改密码或邮箱时需要密码验证)</td>
              </tr>
              <tr>
                <td width="" height="25" bgcolor="" style="width: 70px;">新密码</td>
                <td bgcolor="" width=""><input name='password' type='password' id='password' size="38" maxlength='20'>
        (不想修改请留空)</td>
              </tr>
              <tr>
                <td width="" height="25" bgcolor="" style="width: 70px;">确认新密码</td>
                <td bgcolor="" width=""><input name='repassword' type='password' id='repassword' size="38" maxlength='20'>
        (不想修改请留空)</td>
              </tr>
              <tr>
                <td width="" height="25" bgcolor="" style="width: 70px;">邮箱</td>
                <td bgcolor="" width=""><input name='email' type='text' id='email' value='<?=$user[email]?>' size="38" maxlength='50'></td>
              </tr>
            </tbody>
          </table>
          <div class="pl78">
